    ...
    <div id="main">
        ...
        <!--
            <article class="post">
                <header>
                    <div class="title">
                        <h2><a href="javascript:void(0);">Elements</a></h2>
                ...
                <section>
                    ...
                    This is <u>underlined</u> and this is code: <code>for (;;) { ... }</code>. Finally, <a href="javascript:void(0);">this is a link</a>.</p>
                    <hr />
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col-6 col-12-medium">
                            <ul class="actions">
                                <li><a href="javascript:void(0);" class="button">Default</a></li>
                                <li><a href="javascript:void(0);" class="button">Default</a></li>
                                <li><a href="javascript:void(0);" class="button">Default</a></li>
                            </ul>
                            <ul class="actions small">
                                <li><a href="javascript:void(0);" class="button small">Small</a></li>
                                <li><a href="javascript:void(0);" class="button small">Small</a></li>
                                <li><a href="javascript:void(0);" class="button small">Small</a></li>
                            </ul>
                        ...
                        <div class="col-6 col-12-medium">
                            <ul class="actions stacked">
                                <li><a href="javascript:void(0);" class="button fit">Default</a></li>
                                <li><a href="javascript:void(0);" class="button fit">Default</a></li>
                            </ul>
                            <ul class="actions stacked">
                                <li><a href="javascript:void(0);" class="button small fit">Small</a></li>
                                <li><a href="javascript:void(0);" class="button small fit">Small</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <section>
                    <h3>Buttons</h3>
                    <ul class="actions">
                        <li><a href="javascript:void(0);" class="button large">Large</a></li>
                        <li><a href="javascript:void(0);" class="button">Default</a></li>
                        <li><a href="javascript:void(0);" class="button small">Small</a></li>
                    </ul>
                    <ul class="actions fit">
                        <li><a href="javascript:void(0);" class="button fit">Fit</a></li>
                        <li><a href="javascript:void(0);" class="button fit">Fit</a></li>
                        <li><a href="javascript:void(0);" class="button fit">Fit</a></li>
                    </ul>
                    <ul class="actions fit small">
                        <li><a href="javascript:void(0);" class="button fit small">Fit + Small</a></li>
                        <li><a href="javascript:void(0);" class="button fit small">Fit + Small</a></li>
                        <li><a href="javascript:void(0);" class="button fit small">Fit + Small</a></li>
                    </ul>
                    <ul class="actions">
                        <li><a href="javascript:void(0);" class="button icon solid fa-download">Icon</a></li>
                        <li><a href="javascript:void(0);" class="button icon solid fa-upload">Icon</a></li>
                        <li><a href="javascript:void(0);" class="button icon solid fa-save">Icon</a></li>
                    </ul>
                    <ul class="actions">
        ...
        <ul class="actions pagination">
            ...
            <li><a href="javascript:void(0);" class="button large next">Next Page</a></li>
        </ul>
