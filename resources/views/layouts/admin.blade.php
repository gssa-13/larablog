...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm layout-fixed">
        <!-- Site wrapper -->
        <div class="wrapper">
            <!-- Navbar -->
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <img src="/admin/img/user2-160x160.jpg" class="user-image img-circle elevation-2" alt="User Image">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-footer">
                                <a href="{{ route('admin.users.show', Auth::id() ) }}" class="btn btn-default btn-flat">{{ __('tag.profile') }}</a>
            ...
            <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar-custom">
                    <a href="javascript:void(0)" class="btn btn-link"><i class="fas fa-cogs"></i></a>
                    <a href="javascript:void(0)" class="btn btn-secondary hide-on-collapse pos-right">Help</a>
                </div>
                <!-- /.sidebar-custom -->
            </aside>
        ...
        <script>
            $(function () {
                ...
                $(document).Toasts('create', {
                    class: 'bg-success',
                    title: '{{__('tag.success')}}',
                    subtitle: '{{__('tag.success_sub')}}',
