...
export default new VueRouter({
    routes: [
        ...
        { path: '/categories/:category', name: 'category_posts' ,component: require('./blog/CategoryPost.vue').default },
        { path: '/tags/:tag', name: 'tag_posts' ,component: require('./blog/TagPost.vue').default },
